    ...
    return(
        <nav className="sidemenu">
            ...
            <ul id="topside">
                ...
                <li><img src={require("./media/bag-shopping-solid.svg")} alt="" id="icon"/><a href="">Market</a></li>
...
429.1 86.4 448 68.8 448H64c-17.7 0-32 14.3-32 32s14.3 32 32 32H208c61.9 0 112-50.1 112-112c0-2.5-.1-5-.2-7.5z"/>
                ...
                <li><img src={require("./media/transactions.png")} alt="" id="icon"/><a href="">Transactions</a></li>
            </ul>
